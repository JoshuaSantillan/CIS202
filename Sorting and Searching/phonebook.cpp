/*
	...
	Date: 5/12/19
	Description: Phonebookclass functions that includes a binary search function for name and number
			it also stores all name and numbers in a vector sperating by delimiter and can sort by name/number
*/
#include<algorithm>
#include"phonebook.h"
